<template>
  <my-list :Data.sync="listItem">
    <template #card-content="{item}">
      <v-row class="note_card" align="center">
        <v-col :cols="ismobile?12:8" class="p-0">
          <v-card-title v-if="!ismobile" class="headline font-weight-bold">{{item.name}}</v-card-title>
